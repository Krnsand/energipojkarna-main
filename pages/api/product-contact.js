...
export default async function handler(req, res) {
  ...
  const requiredFields = ['name', 'emailOrPhone', 'product']

  const missingFields = requiredFields.filter(field => !req.body[field]?.length)
  ...
  const mailOptions = {
    ...
    text: `Kund har lämnat intresse om en produkt
Produkt: ${req.body.product}
Namn: ${req.body.name}
Telefon eller email: ${req.body.emailOrPhone}
${utmData}`,
  }
